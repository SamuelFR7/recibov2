...
import { Span } from '../../../components/Print/Span'
import { InfoContainer } from '../../../components/Print/InfoContainer'
import { InfoTitle } from '../../../components/Print/InfoTitle'
      ...
      <div>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <div className="border border-black p-1 font-bold text-right w-[5cm] text-lg">
              <span>
        ...
        <div className="grid grid-flow-col gap-2 w-full mt-2">
          <div className="flex flex-col">
            <div className="h-14" />
            <InfoContainer type="payer" />
            <InfoContainer type="recipient" />
            <InfoTitle>HISTÓRICO:</InfoTitle>
          ...
          <div className="flex flex-col col-span-2">
            ...
            <div className="flex flex-col w-full gap-2 mt-11 [&_span]:h-[29px]">
              ...
              <Span>{receipt?.payerAddress}</Span>
              <Span>{receipt?.payerDocument}</Span>
            </div>
            <div className="flex flex-col w-full gap-2 mt-11 [&_span]:h-[29px]">
              <Span>{receipt?.recipientName}</Span>
              <Span>{receipt?.recipientAddress}</Span>
              <Span>{receipt?.recipientDocument}</Span>
            </div>
